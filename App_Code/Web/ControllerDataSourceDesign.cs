    ...
    public class ControllerDataSourceDesignView : DesignerDataSourceView
    {
        ...
        public override IDataSourceViewSchema Schema
        {
            get
            {
                ...
                Stream res = GetType().Assembly.GetManifestResourceStream(String.Format("IXport.Controllers.{0}.xml", DataController));
                if (res == null)
                	res = GetType().Assembly.GetManifestResourceStream(String.Format("IXport.{0}.xml", DataController));
                if (res != null)
