...
namespace IXport.Handlers
{
	public partial class BlobFactory
    {
        ...
        static BlobFactory()
        {
            ...
            RegisterHandler("AvisosImage", "\"dbo\".\"Avisos\"", "\"Image\"", new string[] {
                        "\"Idavisos\""}, "Avisos Image", "Avisos", "Image");
            RegisterHandler("ComidaImage", "\"dbo\".\"Comida\"", "\"Image\"", new string[] {
                        "\"Idcomida\""}, "Comida Image", "Comida", "Image");
            RegisterHandler("EmpleadoFoto", "\"dbo\".\"Empleado\"", "\"Foto\"", new string[] {
                        "\"IDEmpleado\""}, "Empleado Foto", "Empleado", "Foto");
            RegisterHandler("EmpleadoFirma", "\"dbo\".\"Empleado\"", "\"Firma\"", new string[] {
                        "\"IDEmpleado\""}, "Empleado Firma", "Empleado", "Firma");
            RegisterHandler("FormatosExternalDoc", "\"dbo\".\"Formatos\"", "\"ExternalDoc\"", new string[] {
                        "\"IDFormato\""}, "Formatos Documento externo", "Formatos", "ExternalDoc");
...
function UploadSuccess(key, message) { 
    ...
    public class BlobAdapter
    {
        ...
        public static string ValidationKey
        {
            get
            {
                return "0638D941B0FC5F3FCB19F8F5E21D17F0C57E49FF59D87E18D8059F439CFED783E4571670F4B6217F6" +
