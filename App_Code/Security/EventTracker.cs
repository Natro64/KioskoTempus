...
namespace IXport.Security
{
    ...
    public class EventTrackerBase
    {
        ...
        private static Regex _createdByUserNameRegex = new Regex("CreadoPor", RegexOptions.IgnoreCase);
        
        private static Regex _createdByUserIdRegex = null;
        
        private static Regex _createdOnRegex = new Regex("CreadoEn|FechaCreacion", RegexOptions.IgnoreCase);
